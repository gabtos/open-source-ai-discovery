...
This finding suggests that the code component of a significant portion of models are compatible the OSAID.  However, a much larger subset either omits licensing information, use a custom license or using a license not appropriate for use with software. 
...
### Popular Models
Many models are built using other, larger models. This matters because it appears that large, popularly models used as base (i.e. “foundation” models), will have greater downstream influence. 

Greater understanding of the terms under which these large models are released will be instrumental as we look further into how developers use and interpret the OSAID and Open Source AI.  
```{python}
